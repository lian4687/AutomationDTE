...
public class EmisionFacturaExenta{
	//Varibles
    String user="QA";
    String pass="QAzur2020#";
    String tipoDoc="Factura No Afecta o Exenta Electrónica";
	...
	String comunaRecep ="Cerrillos";
	String ciudadRecep="Santiago";
	String giro="Tecnologia";
	String atencionA="SR";
	String formaPago="Contado";
	String fechaEmi="10-12-2020";
	String fechaVen="23-01-2021";
	String cantidad="1";
	...
	//Modulo
	By LocalizadormoduloEmision= By.xpath("//span[text()='Emisión']");
	By LocalizadorsubModuloEmisionDTE = By.xpath("//span[text()='Emisor DTE']");
	...
	@Test
	public void testEmisionFacturaExenta() throws InterruptedException {
		//Login
		...
		if(driver.findElement(Localizadortitulo).isDisplayed()) {
			...
			if(driver.findElement(LocalizadorsubTituloModulo).isDisplayed()) {
				...
				//driver.findElement(LocalizadorselectorActeco).click();
				//driver.findElement(LocalizadoriconoActeco).click();
				driver.findElement(selectorActeco).click();
