...
public class EmisionNotaCreaditoExportacion {
	
    String user="QA";
    String pass="QAzur2020#";
    String tipoDoc="Nota de Crédito Electrónica de Exportación";
	...
	String typeDoc;
	String tara="10";
	String totalClausuladeVentaExportacion="10";
	...
	@Test
	public void testEmisionNotaCreditoExportacion() throws InterruptedException {
		//Login
				...
				if(driver.findElement(Localizadortitulo).isDisplayed()) {
					...
					if(driver.findElement(LocalizadorsubTituloModulo).isDisplayed()) {
						...
						driver.findElement(LocalizadorTotalClausuladeVentaExportacion).sendKeys(totalClausuladeVentaExportacion);
						driver.findElement(LocalizadorTara).sendKeys(tara);
						...
						case "Nota de Débito de Exportación":
							typeDoc="111";
							break;
						case "Nota de Crédito de Exportación":
							typeDoc="112";
							break;
						default :
