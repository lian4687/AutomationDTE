...
public class EmisionNotaCredito {

	//Varibles
    String user="QA";
    String pass="QAzur2020#";
    String tipoDoc="Nota de Crédito Electrónica";
	...
	String cantidad="1";
	String descripcion="Planificación de Pruebas Automatizadas";
	...
	String typeDoc;
	String folioRef="1";
	String razonRef="Correccion";
	String fechaRef="22-10-2020";
	...
	By LocalizadorModPrecioDetalle =By.xpath("//input[@class='z-longbox' and @size='11' and @maxlength='12']");
	By LocalizadorModPrecioDetalleInvalid= By.xpath("//input[@class='z-longbox z-longbox-invalid' and @size='11' and @maxlength='12']");
	
	By LocalizadorModBotonCrear =By.xpath ("//a[@title='Crear']");
	By LocalizadorBuscMod = By.xpath("//h4[@class='titulotable']");
	// Referencia
	
	By LocalizadorRefFolio= By.xpath("//input[@class='z-textbox' and @tabindex='51']");
	By LocalizadorRefRazon = By.xpath("//input[@class='z-textbox' and @tabindex='54']");
	By LocalizadorRefTipoDocCombo = By.xpath("//input[@class='z-combobox-input' and @tabindex='52']");
	By LocalizadorRefCodRefCombo = By.xpath("//input[@class='z-combobox-input' and @tabindex='55']");
	By LocalizadorRefFechaEmi= By.xpath("//input[@class='z-datebox-input' and @tabindex='53']");
	...
	@Test
	public void testEmisionNotaCredito() throws InterruptedException {
		//Login
		...
		if(driver.findElement(Localizadortitulo).isDisplayed()) {
			...
			if(driver.findElement(LocalizadorsubTituloModulo).isDisplayed()) {
				...
				if(driver.findElement(LocalizadorModPrecioDetalleInvalid).isDisplayed()){
					
					driver.findElement(LocalizadorModPrecioDetalleInvalid).click();
					driver.findElement(LocalizadorModPrecioDetalleInvalid).sendKeys(precio);
				...
				driver.findElement(LocalizadorRefFolio).sendKeys(folioRef);
				driver.findElement(LocalizadorRefRazon).sendKeys(razonRef);
				driver.findElement(LocalizadorRefTipoDocCombo).sendKeys(Keys.ENTER);
				driver.findElement(LocalizadorRefTipoDocCombo).sendKeys(Keys.ARROW_DOWN);
				driver.findElement(LocalizadorRefTipoDocCombo).sendKeys(Keys.ARROW_DOWN);
				driver.findElement(LocalizadorRefTipoDocCombo).sendKeys(Keys.ARROW_DOWN);
				driver.findElement(LocalizadorRefTipoDocCombo).sendKeys(Keys.ARROW_DOWN);
				driver.findElement(LocalizadorRefFechaEmi).sendKeys(fechaRef);
				driver.findElement(LocalizadorRefCodRefCombo).sendKeys(Keys.ENTER);
				driver.findElement(LocalizadorRefCodRefCombo).sendKeys(Keys.ARROW_DOWN);
				driver.findElement(LocalizadorRefCodRefCombo).sendKeys(Keys.ARROW_DOWN);
