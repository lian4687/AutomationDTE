...
public class EmisionFacturaCompra {
	//Varibles
    String user="QA";
    String pass="QAzur2020#";
    String tipoDoc="Factura de Compra Electrónica";
	...
	By LocalizadorAtenciónA = By.xpath("//input[@class='z-textbox' and @tabindex='13']");
	...
	@Test
	public void testEmisionFacturaCompra() throws InterruptedException {
		//Login
