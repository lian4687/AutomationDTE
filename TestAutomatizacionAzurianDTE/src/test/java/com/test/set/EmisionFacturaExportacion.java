...
public class EmisionFacturaExportacion {
	//Varibles
    String user="QA";
    String pass="QAzur2020#";
    String tipoDoc="Factura Electrónica de Exportación";
	...
	@Test
	public void testEmisionFacturaExportacion() throws InterruptedException {
		//Login
