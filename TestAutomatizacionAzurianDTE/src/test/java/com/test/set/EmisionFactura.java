...
public class EmisionFactura {
    ...
    String tipoDoc="Factura Electrónica";
	...
	By LocalizadorAtenciónA = By.xpath("//input[@class='z-textbox' and @tabindex='14']");
	...
	@Test
	public void EmisionFacturatest() throws InterruptedException {
		//Login
